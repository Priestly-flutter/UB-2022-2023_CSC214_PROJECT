...
<html lang="en">
    <head>
        ...
        <title>RDSE Student|  Student result info < </title>
...
$ret = "SELECT tblstudents.StudentName,tblclasses.ExamName,tblclasses.Section from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=tblstudents.ExamId where tblstudents.StudentId=:stid limit 1";
...
{  ?>
                                            ...
                                            <label for="default" class="col-sm-2 control-label">Exam</label>
                                                        <div class="col-sm-10">
<?php echo htmlentities($row->ExamName)?>(<?php echo htmlentities($row->Section)?>)
                                                        </div>
                                                    </div>
<div class="form-group">
