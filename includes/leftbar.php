<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                ...
                                <h6 class="title">GBHS MOLYKO</h6>
                                <small class="info">South West</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Student Exams</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="create-class.php"><i class="fa fa-bars"></i> <span>Create Exam</span></a></li>
                                            <li><a href="manage-classes.php"><i class="fa fa fa-server"></i> <span>Manage Exam</span></a></li>
...
<li class="has-children">
                    ...
                    <!-- This code was written partially with Ai and some resources were gottone from youtube-->