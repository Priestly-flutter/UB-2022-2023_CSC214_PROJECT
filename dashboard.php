...
<html lang="en">
    <head>
        ...
        <title>RDSE System | Dashboard</title>
...
$totalexam=$query2->rowCount();
?>
                                            <span class="number counter"><?php echo htmlentities($totalexam);?></span>
                                            <span class="name">Total Exam listed</span>
