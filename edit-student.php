...
<html lang="en">
    <head>
        ...
        <title>RDESE School| Edit Student  </title>
...
<?php }?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
<input type="text" name="classname" class="form-control" id="classname" value="<?php echo htmlentities($result->ExamName)?>(<?php echo htmlentities($result->Section)?>)" readonly>
                                                        </div>
                                                    </div>
<div class="form-group">
