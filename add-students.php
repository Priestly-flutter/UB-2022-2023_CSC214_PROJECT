...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ExamId,DOB,Status) VALUES(:studentname,:roolid,:studentemail,:gender,:examid,:dob,:status)";
...
<html lang="en">
    <head>
        ...
        <title>RDSE School| Student Admission< </title>
