...
$examnamenumeric=$_POST['examnamenumeric'];
$section=$_POST['section'];
$eid=intval($_GET['examid']);
$sql="update  tblclasses set ExamName=:examname,ExamNameNumeric=:examnamenumeric,Section=:section where id=:eid ";
$query = $dbh->prepare($sql);
$query->bindParam(':examname',$examname,PDO::PARAM_STR);
$query->bindParam(':examnamenumeric',$examnamenumeric,PDO::PARAM_STR);
...
<html lang="en">
    <head>
        ...
        <title>RDSE School Update Exam</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update Student Exam</h2>
                                </div>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                			<input type="text" name="classname" value="<?php echo htmlentities($result->ExamName);?>" required="required" class="form-control" id="success">
                                                            <span class="help-block">Eg- GCE A-level etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Exam Name in Numeric</label>
                                                        <div class="">
                                                            <input type="number" name="classnamenumeric" value="<?php echo htmlentities($result->ExamNameNumeric);?>" required="required" class="form-control" id="success">
